...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 CHANGELOG.md exists with Keep a Changelog format
- [x] #2 README includes installation instructions via Homebrew
- [x] #3 RELEASING.md (or README section) documents how to cut a release
- [x] #4 GitHub secrets setup is documented
<!-- AC:END -->
